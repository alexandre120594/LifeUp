...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6 p-4 md:p-8">
      ...
      <OverviewPanel
        title="Life workspace at a glance"
        description="Track projects, routines, tasks, planning, and money from one operational view."
        stats={overviewStats}
        progress={{
        ...
        focusDescription="Use the popup to add a project, habit, or task without leaving the Life Dashboard."
        focusItems={[
          {
            label: "Pending tasks",
